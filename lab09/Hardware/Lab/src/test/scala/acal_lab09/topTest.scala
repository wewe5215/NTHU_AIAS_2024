...
class topTest(dut:top) extends PeekPokeTester(dut){
    ...
    println(s"[Mem_Read_Stall_Cycle_Count     ] ${"%8d".format(Mem_Read_Stall_Cycle_Count)}")
    println(s"[Mem_Write_Stall_Cycle_Count    ] ${"%8d".format(Mem_Write_Stall_Cycle_Count)}")
    println(s"[Mem_Read_Request_Count         ] ${"%8d".format(Mem_Read_Request_Count)}")
    println(s"[Mem_Write_Request_Count        ] ${"%8d".format(Mem_Write_Request_Count)}")
    println(s"[Mem_Read_Bytes_Count           ] ${"%8d".format(Mem_Read_Bytes_Count)}")
    println(s"[Mem_Write_Bytes_Count          ] ${"%8d".format(Mem_Write_Bytes_Count)}")
    /* Lab 9_3 performance counter */
