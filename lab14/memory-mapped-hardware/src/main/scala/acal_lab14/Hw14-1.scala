...
class top_Hw14_1 extends Module {
    ...
    val cpu = Module(new SingleCycleCPU(Hw14_1_Config.s_id_width, Hw14_1_Config.addr_width, Hw14_1_Config.data_width, Hw14_1_Config.instr_hex_path))
    ...
    val dma = Module(new DMA(Hw14_1_Config.s_id_width, Hw14_1_Config.addr_width, Hw14_1_Config.data_width, Hw14_1_Config.Dma_Base_ADDR))
